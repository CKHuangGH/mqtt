...
scp -o StrictHostKeyChecking=no ./runner1-deployment.yaml chuang@172.16.111.106:/home/chuang/protocolsuite_smart_city_mqttv5_mosquitto/$time/deployment_files/runner1-deployment.yaml
scp -o StrictHostKeyChecking=no ./runner2-deployment.yaml chuang@172.16.111.106:/home/chuang/protocolsuite_smart_city_mqttv5_mosquitto/$time/deployment_files/runner2-deployment.yaml
scp -o StrictHostKeyChecking=no ./runner3-deployment.yaml chuang@172.16.111.106:/home/chuang/protocolsuite_smart_city_mqttv5_mosquitto/$time/deployment_files/runner3-deployment.yaml
scp -o StrictHostKeyChecking=no ./runner4-deployment.yaml chuang@172.16.111.106:/home/chuang/protocolsuite_smart_city_mqttv5_mosquitto/$time/deployment_files/runner4-deployment.yaml
scp -o StrictHostKeyChecking=no ./runner5-deployment.yaml chuang@172.16.111.106:/home/chuang/protocolsuite_smart_city_mqttv5_mosquitto/$time/deployment_files/runner5-deployment.yaml
rm -rf results/
...
scp -o StrictHostKeyChecking=no results.tar.gz chuang@172.16.111.106:/home/chuang/scalabilitysuite_smart_city_mqttv5_nanomq/$time
...
scp -o StrictHostKeyChecking=no ./runner6-deployment.yaml chuang@172.16.111.106:/home/chuang/scalabilitysuite_smart_city_mqttv5_nanomq/$time/deployment_files/runner6-deployment.yaml
scp -o StrictHostKeyChecking=no ./runner7-deployment.yaml chuang@172.16.111.106:/home/chuang/scalabilitysuite_smart_city_mqttv5_nanomq/$time/deployment_files/runner7-deployment.yaml
scp -o StrictHostKeyChecking=no ./runner8-deployment.yaml chuang@172.16.111.106:/home/chuang/scalabilitysuite_smart_city_mqttv5_nanomq/$time/deployment_files/runner8-deployment.yaml
rm -rf results/
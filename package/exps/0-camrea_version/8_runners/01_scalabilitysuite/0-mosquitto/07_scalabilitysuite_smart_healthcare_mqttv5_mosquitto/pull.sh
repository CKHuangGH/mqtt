...
scp -o StrictHostKeyChecking=no results-$time.tar.gz chuang@172.16.111.106:/home/chuang/scalabilitysuite_smart_healthcare_mqttv5_mosquitto/
...
scp -o StrictHostKeyChecking=no ./runner6-deployment.yaml chuang@172.16.111.106:/home/chuang/scalabilitysuite_smart_healthcare_mqttv5_mosquitto/$time/deployment_files/runner6-deployment.yaml
scp -o StrictHostKeyChecking=no ./runner7-deployment.yaml chuang@172.16.111.106:/home/chuang/scalabilitysuite_smart_healthcare_mqttv5_mosquitto/$time/deployment_files/runner7-deployment.yaml
scp -o StrictHostKeyChecking=no ./runner8-deployment.yaml chuang@172.16.111.106:/home/chuang/scalabilitysuite_smart_healthcare_mqttv5_mosquitto/$time/deployment_files/runner8-deployment.yaml
rm -rf results/
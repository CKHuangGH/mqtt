...
scp -o StrictHostKeyChecking=no results-$time.tar.gz chuang@172.16.111.106:/home/chuang/scalabilitysuite_smart_home_mqttv5_10x_mochi/
...
scp -o StrictHostKeyChecking=no ./runner3-deployment.yaml chuang@172.16.111.106:/home/chuang/scalabilitysuite_smart_home_mqttv5_10x_mochi/$time/deployment_files/runner3-deployment.yaml
scp -o StrictHostKeyChecking=no ./runner4-deployment.yaml chuang@172.16.111.106:/home/chuang/scalabilitysuite_smart_home_mqttv5_10x_mochi/$time/deployment_files/runner4-deployment.yaml
scp -o StrictHostKeyChecking=no ./runner5-deployment.yaml chuang@172.16.111.106:/home/chuang/scalabilitysuite_smart_home_mqttv5_10x_mochi/$time/deployment_files/runner5-deployment.yaml
scp -o StrictHostKeyChecking=no ./runner6-deployment.yaml chuang@172.16.111.106:/home/chuang/scalabilitysuite_smart_home_mqttv5_10x_mochi/$time/deployment_files/runner6-deployment.yaml
scp -o StrictHostKeyChecking=no ./runner7-deployment.yaml chuang@172.16.111.106:/home/chuang/scalabilitysuite_smart_home_mqttv5_10x_mochi/$time/deployment_files/runner7-deployment.yaml
scp -o StrictHostKeyChecking=no ./runner8-deployment.yaml chuang@172.16.111.106:/home/chuang/scalabilitysuite_smart_home_mqttv5_10x_mochi/$time/deployment_files/runner8-deployment.yaml
rm -rf results/
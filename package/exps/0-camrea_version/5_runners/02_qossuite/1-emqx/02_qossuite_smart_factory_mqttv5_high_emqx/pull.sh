...
ssh -o StrictHostKeyChecking=no chuang@172.16.111.106 "mkdir -p /home/chuang/qossuite_smart_factory_mqttv5_high/"
tar -I 'gzip -9' -cf results-$time.tar.gz results/
scp -o StrictHostKeyChecking=no results-$time.tar.gz chuang@172.16.111.106:/home/chuang/qossuite_smart_factory_mqttv5_high/
ssh -o StrictHostKeyChecking=no chuang@172.16.111.106 "mkdir -p /home/chuang/qossuite_smart_factory_mqttv5_high/$time/deployment_files/"
scp -o StrictHostKeyChecking=no ./runner1-deployment.yaml chuang@172.16.111.106:/home/chuang/qossuite_smart_factory_mqttv5_high/$time/deployment_files/runner1-deployment.yaml
scp -o StrictHostKeyChecking=no ./runner2-deployment.yaml chuang@172.16.111.106:/home/chuang/qossuite_smart_factory_mqttv5_high/$time/deployment_files/runner2-deployment.yaml
scp -o StrictHostKeyChecking=no ./runner3-deployment.yaml chuang@172.16.111.106:/home/chuang/qossuite_smart_factory_mqttv5_high/$time/deployment_files/runner3-deployment.yaml
scp -o StrictHostKeyChecking=no ./runner4-deployment.yaml chuang@172.16.111.106:/home/chuang/qossuite_smart_factory_mqttv5_high/$time/deployment_files/runner4-deployment.yaml
scp -o StrictHostKeyChecking=no ./runner5-deployment.yaml chuang@172.16.111.106:/home/chuang/qossuite_smart_factory_mqttv5_high/$time/deployment_files/runner5-deployment.yaml
rm -rf results/
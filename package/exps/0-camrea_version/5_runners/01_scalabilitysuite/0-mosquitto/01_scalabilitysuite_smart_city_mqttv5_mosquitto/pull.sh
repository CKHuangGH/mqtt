...
scp -o StrictHostKeyChecking=no ./mosquitto-deployment.yaml chuang@172.16.111.106:/home/chuang/scalabilitysuite_smart_city_mqttv5_mosquitto/$time/deployment_files/mosquitto-deployment.yaml
scp -o StrictHostKeyChecking=no ./mosquitto.conf chuang@172.16.111.106:/home/chuang/scalabilitysuite_smart_city_mqttv5_mosquitto/$time/deployment_files/mosquitto.conf
scp -o StrictHostKeyChecking=no ./runner-service.yaml chuang@172.16.111.106:/home/chuang/scalabilitysuite_smart_city_mqttv5_mosquitto/$time/deployment_files/runner-service.yaml
rm -rf results/
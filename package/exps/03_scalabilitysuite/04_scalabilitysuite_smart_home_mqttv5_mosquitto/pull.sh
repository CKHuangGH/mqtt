...
ssh -o StrictHostKeyChecking=no chuang@172.16.79.101 "mkdir -p /home/chuang/protocolsuite_smart_city_mqttv5_mosquitto/"
scp -o StrictHostKeyChecking=no -r ./results chuang@172.16.79.101:/home/chuang/protocolsuite_smart_city_mqttv5_mosquitto/$time

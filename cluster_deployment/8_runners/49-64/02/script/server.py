...
name = "mqtt-2-now-long-rennes-49-64"
clusters = "paradoxe"
site = "rennes"
duration = "03:10:00"
...
pool = [f"paradoxe-{i}.rennes.grid5000.fr" for i in range(49, 65)]
...
conf = (
    ...
    .add_machine(roles=["role2"], servers=pool, nodes=1, primary_network=prod_network)
    .finalize()
)
